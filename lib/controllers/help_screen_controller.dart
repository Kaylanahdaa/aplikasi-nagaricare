...
class HelpScreenController extends GetxController {
  ...
  Future<void> searchByEmail(String email) async {
    ...
    if (userId != null) {
      final url = Uri.parse("http://172.20.10.9:3000/users/$userId");
          ...
          if (data != null && data['email'] == email) {
            userData.value = {
              ...
              'profile': (data['profile_picture'] != null &&
                  ...
                  : 'http://172.20.10.9:3000/users/profilepicture/${data['id_user']}', // Provide default value if profile_picture is not a full URL
